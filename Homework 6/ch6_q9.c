...
int main(void) {
    ...
    IPC0bits.INT0IP = 6;                // step 4: set INT0 to priority 6
    IPC0bits.INT0IS = 0;                // step 4: set INT0 to subpriority 0
    IPC1bits.INT1IP = 6;                // step 4: set INT1 to priority 6
    IPC0bits.INT1IS = 0;                // step 4: set INT1 to subpriority 0
    IFS0bits.INT0IF = 0;                // step 5: clear INT0 flag status
    IFS0bits.INT1IF = 0;                // step 5: clear INT1 flag status
    IEC0bits.INT0IE = 1;                // step 6: enable INT0 interrupt
    IEC0bits.INT1IE = 1;                // step 6: enable INT1 interrupt
